        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <aside
              ...
              } flex-col lg:col-span-1 bg-gaming-black border border-gaming-gray rounded-3xl shadow-xl h-fit overflow-hidden`}
            >
              <div className="relative overflow-hidden bg-gradient-to-b from-[#1c1f26] to-[#0A0D14] border-b border-[#FFBD03]/30 px-5 py-3.5 flex items-center justify-between shadow-md">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between text-[9px] font-black text-gray-500 uppercase tracking-wider">
                  ...
                  <span className="text-digital-yellow font-black">{minRating}</span>
                </div>
                <input
                  type="range"
                  min="0"
